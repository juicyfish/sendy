...
<?php 
	...
	//track_opens (1 or 0)
	$track_opens = isset($_POST['track_opens']) && ($_POST['track_opens']==1 || $_POST['track_opens']==0)  ? mysqli_real_escape_string($mysqli, $_POST['track_opens']) : 1;
	
	//track_clicks (1 or 0)
	$track_clicks = isset($_POST['track_clicks']) && ($_POST['track_clicks']==1 || $_POST['track_clicks']==0) ? mysqli_real_escape_string($mysqli, $_POST['track_clicks']) : 1;

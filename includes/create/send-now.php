...
$cron = $_POST['cron'];
$email_list = $_POST['email_list']!='' ? mysqli_real_escape_string($mysqli, $_POST['email_list']): 0;
...
//get smtp settings
$q = 'SELECT smtp_host, smtp_port, smtp_ssl, smtp_username, smtp_password, allocated_quota, gdpr_only, custom_domain, custom_domain_protocol, custom_domain_enabled FROM apps WHERE id = '.$app.' AND userID = '.get_app_info('main_userID');
$r = mysqli_query($mysqli, $q);
...
$sent_formatted = strftime("%a, %b %d, %Y, %I:%M%p", $time);
